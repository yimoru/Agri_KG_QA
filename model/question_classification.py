#!/usr/bin/python3
# -*- coding: UTF-8 -*-
# @Time    : 2023/3/30 16:17
# @Author  : yimoru
# @FileName: question_classification.py
# @software: PyCharm
# @Desc    :
...
class Question_classify():
    ...
    def read_train_data(self):
        train_x = []
        train_y = []
        path = os.path.abspath('..') + "/data/question/"
    ...
    def train_model_NB(self):
        ...
        joblib.dump(self.tv, 'tfidf_model.m')
        joblib.dump(clf, 'intent_reg_model.m')
        return clf
